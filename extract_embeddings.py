...
def create_embeddings():
	...
	embedder = cv2.dnn.readNetFromTorch(os.path.join(os.getcwd(), 'openface_nn4.small2.v1.t7'))
	...
	#check_path(os.path.join(os.getcwd(),'output'))
	f = open(os.path.join(os.getcwd(), 'output', 'embeddings.pickle'), "wb")
