...
a = Analysis(['faceable.py'],
             ...
             binaries=[],
             datas=[('caffe/deploy.prototxt.txt','caffe'),('caffe/res10_300x300_ssd_iter_140000.caffemodel','caffe'),('static/black.png','static'),('static/faceable_logo.png','static'),('static/faceable_logo.ico','static'),('dataset/unknown','dataset/unknown'),('openface_nn4.small2.v1.t7','.'),('screens.kv','.'),('static/loading.gif','static'),('Faceable.xml','.'),('Faceable Runner.xml','.'),('Faceable Killer.xml','.'),('schedule.bat','.'),('start.bat','.'),('stop.bat','.')],
