...
OutputBaseFilename=faceable_v7.0.4
;SetupIconFile=your_path_here
Compression=lzma
...
[Files]
Source: "your_path_of_exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "your_path_of_folders_to_bundle"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs skipifsourcedoesntexist
